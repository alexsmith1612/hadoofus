...
static struct {
	...
	[H_UNRESOLVED_LINK_EXCEPTION - _H_EXCEPTION_START] = {
		.type = UNRESLINK_EXCEPTION_STR, },
	[H_REPLICA_NOT_FOUND_EXCEPTION - _H_EXCEPTION_START] = {
		.type = REPLICA_NOTFOUND_EXCEPTION_STR, },
	[H_STANDBY_EXCEPTION - _H_EXCEPTION_START] = {
		.type = STANDBY_EXCEPTION_STR, },
	[H_RECOVERY_IN_PROGRESS_EXCEPTION - _H_EXCEPTION_START] = {
		.type = RECOVERY_INPROGRESS_EXCEPTION_STR, },
};
